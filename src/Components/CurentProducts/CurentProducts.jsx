...
export default function CurentProducts() {
    ...
    // function getCurentProduct() {
    //     axios.get(`https://ecommerce.routemisr.com/api/v1/products`)
    //         .then(({ data }) => {
    //             // console.log(data?.data);
    //             setCurentProducts(data?.data)
    //         })
    //         .catch(({ data }) => {
    ...
    return (<>
        <div className='flex flex-wrap xl:p-10 mt-5'>

            {data?.map((product) => {
                return <div key={product.id} className="product w-full md:w-1/2 lg:w-1/4 xl:w-1/5 p-3">
                    <div className="relative flex flex-col items-center justify-center mt-10">
                        <motion.div variants={divVariants} initial='hidden' whileInView='visible' className="container">
