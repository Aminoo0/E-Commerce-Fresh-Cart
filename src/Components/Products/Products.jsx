...
export default function Products() {
    ...
    return (<div className='overflow-hidden'>
        ...
        <div className='p-5 hover:translate-x-10 duration-500'>
            <h1 className='text-5xl text-slate-500 my-5'>Products</h1>
        </div>
        <div className='flex flex-wrap p-5'>
            {data?.map((product) => {
                return <div key={product.id} className="product w-full md:w-1/2 xl:w-1/5 p-3">
                    <div className="relative flex flex-col items-center justify-center ">
                        <motion.div initial={{ x: -300, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 2, x: { type: 'spring', stiffness: 120 } }} className="container">
                                ...
                                <div className="flex flex-col ">
                                    ...
                                    <div className="flex-auto justify-evenly">
                                        ...
                                        <div className="flex space-x-2 text-sm font-medium justify-start mt-5">
                                            <button onClick={() => addProductToCart(product.id)} className="transition-all w-full ease-in inline-flex items-center text-sm font-medium mb-2 md:mb-0 bg-purple-500 px-5 py-2 hover:shadow-lg hover:tracking-widest duration-300 text-white rounded-full hover:bg-purple-600 ">
                                                <span>Add Cart</span>
                                            </button>
